...
import img1 from '@/assets/portrait.jpeg'
import acceuilBg from '@/assets/acceuil-bg.jpeg'
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
                    <p className="text-secondary font-body text-sm md:text-base tracking-[0.3em] uppercase mb-6 animate-fade-in">
                        4<sup>e</sup> Circonscription Électorale — Natitingou &
                        Toucountouna
                    </p>
                    ...
                    <p
                        className="text-primary-foreground/80 text-lg md:text-xl max-w-2xl mx-auto mb-10 animate-fade-in-up"
                        style={{ animationDelay: '0.2s' }}>
                        Pour une 4<sup>e</sup> circonscription plus forte et
                        plus unie. Ensemble, bâtissons l'avenir de l'Atacora.
                    </p>
                    <div
                    ...
                    <div className="section-fade-in grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-6">
                                Un homme au service de{' '}
                                <span className="text-secondary">
                                    sa communauté
                                </span>
                            </h2>
                            <p className="text-muted-foreground leading-relaxed mb-6">
                                Dr Désiré YASSO est un fils de l'Atacora,
                                profondément engagé dans le développement de sa
                                région. Docteur en sciences politiques, il met
                                son expertise et sa passion au service des
                                populations de Natitingou et Toucountouna.
                            </p>
                            <p className="text-muted-foreground leading-relaxed mb-8">
                                Son parcours exceptionnel, alliant formation
                                académique de haut niveau et engagement
                                communautaire, fait de lui un leader naturel
                                pour la 4<sup>e</sup> circonscription
                                électorale.
                            </p>
                            <Link
                                to="/a-propos"
                        ...
                        <div className="relative">
                            ...
                            <img
                                src={img1}
                                alt="Dr Désiré YASSO"
                                className="relative rounded-2xl shadow-2xl mt-15 w-full object-cover aspect-square"
                                loading="lazy"
                                width={800}
                                height={1024}
                            />
                        ...
                        {[
                            {
                                icon: Users,
                                title: 'Proximité',
                                desc: "Être à l'écoute des populations et répondre à leurs besoins réels au quotidien.",
                            },
                            {
                                icon: BookOpen,
                                title: 'Éducation',
                                desc: "Promouvoir l'accès à une éducation de qualité pour tous les enfants de la circonscription.",
                            },
                            {
                                icon: Heart,
                                title: 'Solidarité',
                                desc: 'Renforcer les liens communautaires et soutenir les plus vulnérables.',
                            },
                            {
                                icon: MapPin,
                                title: 'Développement',
                                desc: "Impulser des projets d'infrastructure et de modernisation pour l'Atacora.",
                            },
                        ].map((v, i) => (
                            <div
                                key={i}
                        ...
                        {[
                            {
                                img: community,
                                city: 'Natitingou',
                                desc: "Chef-lieu du département de l'Atacora, carrefour économique et culturel majeur du Nord-Bénin.",
                            },
                            {
                                img: development,
                                city: 'Toucountouna',
                                desc: "Commune riche de sa culture et de ses traditions, au cœur des montagnes de l'Atacora.",
                            },
                        ].map((zone, i) => (
                            <div
                                key={i}
                                className="section-fade-in hover-lift group rounded-2xl overflow-hidden shadow-lg">
            ...
            <section className="py-24 bg-muted">
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="section-fade-in flex items-end justify-between mb-12">
                        ...
                        <Link
                            to="/actualites"
                            className="hidden md:inline-flex items-center gap-2 text-secondary font-semibold hover:gap-3 transition-all">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            {
                                date: '5 Avril 2026',
                                title: 'Inauguration du nouveau centre de santé de Natitingou',
                                excerpt:
                                    "Un pas de plus vers l'amélioration de l'accès aux soins pour les populations de la 4e circonscription.",
                            },
                            {
                                date: '28 Mars 2026',
                                title: 'Rencontre avec les jeunes de Toucountouna',
                                excerpt:
                                    "Dr Yasso échange avec la jeunesse sur les défis de l'emploi et de la formation professionnelle.",
                            },
                            {
                                date: '15 Mars 2026',
                                title: "Projet d'adduction d'eau potable lancé",
                                excerpt:
                                    "Un projet majeur pour apporter l'eau potable à plus de 5 000 habitants des zones rurales.",
                            },
                        ].map((article, i) => (
                            <Link
                                key={i}
                                ...
                                <div className="p-6">
                                    <p className="text-secondary text-xs font-semibold tracking-wider uppercase mb-3">
                                        {article.date}
                                    </p>
                ...
                <div className="relative container mx-auto px-4 lg:px-8 text-center">
                    <div className="section-fade-in max-w-3xl mx-auto">
                        <h2 className="font-heading text-3xl md:text-5xl font-bold text-primary-foreground mb-6">
                            Ensemble, construisons l'avenir de{' '}
                            <span className="text-secondary">l'Atacora</span>
                        </h2>
                        <p className="text-primary-foreground/70 text-lg mb-10">
                            Votre soutien compte. Rejoignez le mouvement pour
                            une 4<sup>e</sup> circonscription plus forte, plus
                            unie et plus prospère.
                        </p>
